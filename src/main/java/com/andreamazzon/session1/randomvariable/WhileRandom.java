 ...
 * launches after which a tail is obtained.
 *
...
public class WhileRandom {
	...
	public static void main(String[] args) {
		...
		/*
		 * the seed is an initialization value for the random number generator: the generator will always produce
		 * the same sequence for a particular seed value
		 */
		do {
