...
/**
 * Examples of switch statement: it selects among pieces of codes based on the value of an integral expression,
...
public class ARandomSwitch {
	...
	public static void main(String[] args) {
		 ...
		 */
		case 1:
			System.out.println("The selected number is " + 1);
		...
		case 3:
			System.out.println("The selected number is " + 3);
			break;
		...
		default: //if no match occurs
			...
			/*
			 * the last statement, following the default, doesn’t have a break because the execution just falls
			 * through to where the break would have taken it anyway. You could put a break at the end of the
