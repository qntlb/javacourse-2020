...
public class Operators {
	...
	public static void main(String[] args) {
		...
		int a = 5; // Since it is a primitive, a will contain the actual value and not the reference to an object.
		 ...
		 * copying a reference from one place to another. See the code in com.andreamazzon.session1.tank to see what happens
		 */
		int c = a + b;
		 ...
		 * It is implicit and NOT (double) a
		 */
		System.out.println("The sum of " + a + "" + " and " + b1 + " is still " + h);

		// More types
		String s = "string!"; // or String s= new String("string!"); not a primitive
