...
/**
 * This class is used by an user in order to get the result of an exponentiation. If the base is a negative
...
public class PowerMain {
	...
	public static void main(String[] args) {
		...
		double base = -0.2; //negative number!
		int intExponent = 2;
		double doubleExponent = 2.2;
