...
/**
 * The main use of this class is to print a message. It has one field, messageToBePrinted, one (default)
 * constructor, whose side effect is to print a message, and two methods, printMessage() and
