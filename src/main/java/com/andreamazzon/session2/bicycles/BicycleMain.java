...
/**
 * In the main method of this class we construct some objects of type Bicycle (i.e., instances of the class
 * Bicycle). This is to show you how the value of a static field is shared among all objects of the class, and
