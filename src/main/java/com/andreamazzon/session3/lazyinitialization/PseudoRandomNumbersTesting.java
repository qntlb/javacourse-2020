...
/**
 * This class contains one main method that calls method of the class LinearCongruentialGenerator: example of lazy
 * initialization.
 *
...
public class PseudoRandomNumbersTesting {
	public static void main(String[] args) {
		...
		LinearCongruentialGenerator firstGenerator = new LinearCongruentialGenerator(numberOfPseudoRandomNumbers, firstSeed);
		...
		LinearCongruentialGenerator secondGenerator = new LinearCongruentialGenerator(numberOfPseudoRandomNumbers, secondSeed);
