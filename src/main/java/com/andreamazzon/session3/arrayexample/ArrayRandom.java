...
/**
 * This class illustrates some features of arrays n Java by creating an array of random length and filling it
 * with random numbers between 1 and 500
 *
...
public class ArrayRandom {
	public static void main(String[] args){
		...
		System.out.println("The array a is " + Arrays.toString(a)/*Here is a nice way to print the values of an array*/); //It is initialized with all zeros
		/*
