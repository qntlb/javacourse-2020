 ...
 * Here we consider a binomial model, i.e., discrete model for a stochastic process S, such that for every
 * time i we have
 * S(i+1)=S(i)*M(i),
...
public class BinomialModelUser extends StochasticProcessUser{
	...
	BinomialModelUser(double initialValue, double increaseIfUp, double decreaseIfDown, int seed, int lastTime, int numberOfSimulations){
