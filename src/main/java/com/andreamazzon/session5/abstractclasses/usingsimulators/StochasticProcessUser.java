...
/**
 * This class has methods to get the paths, the simulated value at a given time and the average value
 * at given time of a general stochastic process.
 * The implementation of the methods doing this is given, but is based on the generation of the realizations
 * of the process. Since this is based on the specific type of the process, it gets implemented in the
 * derived classes and is therefore abstract.
 *
 * @author Andrea Mazzon
 *
 */
public abstract class StochasticProcessUser {
