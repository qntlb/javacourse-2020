...
/**
 * This class illustrates an use of upcasting: the method nextShape() returns an object of type Shape. We know that
 * we cannot create objects whose specific type is Shape, because Shape is abstract, and actually indeed we return a
 * Circle, a Square or a Triangle. This is possible because they get automatically upcasted to Shape when returned:
 * the reference to a Circle can be also treated as a reference of a Shape.
...
public class RandomShapeGenerator {
	...
	Shape nextShape() { // Upcasting in the return type
		...
		case 0:
			...
			return newCircle; // upcasted to Shape.
		case 1:
