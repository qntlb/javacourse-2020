...
/**
 * This class is used in order to simulate some paths of a binomial model: discrete model for a stochastic
...
public class BinomialModelSimulator extends StochasticProcessSimulator
{
	...
	public BinomialModelSimulator(double initialValue, double increaseIfUp, double decreaseIfDown, double interestRate, int seed,
	...
	public BinomialModelSimulator(double initialValue, double increaseIfUp, double decreaseIfDown, int seed, int lastTime, int numberOfSimulations){
	...
	public BinomialModelSimulator(double initialValue, double increaseIfUp, double decreaseIfDown, int lastTime, int numberOfSimulations){
	 ...
	 * if the simulated number is less that this we will return an up, otherwise a down
	 */
	 ...
	 *  upsAndDowns[i][j] = u if  randomGenerator.getNextInteger() < threshold,
	 *                    = d if randomGenerator.getNextInteger() >= threshold.
	...
	private double[][] generateUpsAndDowns() {
		...
		long threshold = convert();//when the simulated number is less than this, we have up
