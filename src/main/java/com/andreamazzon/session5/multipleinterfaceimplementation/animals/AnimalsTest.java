...
public class AnimalsTest {
	...
	static void makeSwim(AnimalThatSwims s) {//an object of any class implementing AnimalThatSwims: polymorphism
		s.swim();
	}

	static void makeFly(AnimalThatFlies f) {//an object of any class implementing AnimalThatFlies: polymorphism
		f.fly();
	}
