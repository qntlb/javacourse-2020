 ...
 * However, it can also be called by passing objects of type Frog or Toad: they get upcasted. In this way,
 * polymorphism is achieved: the code doesn’t rely on the specific type of the objects, but its execution
...
public class Amphibian{
	 ...
	 * to this: at run time, Java is able to get the type of the object, so that the right implementation of
